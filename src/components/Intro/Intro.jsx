    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>M.Khalid Irfani</span>
          <span>
            MERN Stack Developer with high level of experience in web designing
            and development, producting the Quality work
            a professional web developer having strong expertise in HTML5, CSS3, JavaScript, TypeScript, React, Next, Tailwind-CSS, Material UI, and Bootstrap with more than 1 years of experience.Thanks
          </span>
        </div>
